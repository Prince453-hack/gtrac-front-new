...
export const SensorAnatomy = () => {
  ...
  return (
    <div
      className="relative w-full py-28 px-6 sm:px-12 lg:px-20 overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto text-center mb-16 z-10">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-emerald-50 border border-emerald-200/60 mb-4"
        >
        ...
        <motion.p
          ...
          className={`${poppins.className} text-zinc-600 text-sm sm:text-base mt-3 max-w-xl mx-auto leading-relaxed`}
        >
      ...
      <div className="relative w-full max-w-7xl mx-auto min-h-175 flex items-center justify-center my-6 z-10">
        ...
        <motion.div
          ...
          className="relative z-20 flex flex-col items-center justify-center my-8 lg:my-0"
        >
        ...
        <div className="static lg:absolute lg:left-[4%] xl:left-[8%] top-0 bottom-0 flex flex-col justify-between py-6 gap-6 w-full lg:w-[28%] z-30">
        ...
        <div className="static lg:absolute lg:right-[4%] xl:right-[8%] top-0 bottom-0 flex flex-col justify-between py-6 gap-6 w-full lg:w-[28%] z-30">
